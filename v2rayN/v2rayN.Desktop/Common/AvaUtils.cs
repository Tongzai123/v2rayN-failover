...
internal class AvaUtils
{
    ...
    public static WindowIcon GetAppIcon(ESysProxyType sysProxyType, bool isTunEnabled)
    {
        var index = TunModeBehavior.GetNotifyIconIndex(sysProxyType, isTunEnabled) + 1;
