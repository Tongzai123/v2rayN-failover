...
public partial class OptionSettingWindow : WindowBase<OptionSettingViewModel>
{
    ...
    public OptionSettingWindow()
    {
        ...
        txtFailoverRelayFirstByteTimeoutMs.LostFocus += (_, _) => ViewModel?.NormalizeFailoverRelayFirstByteTimeoutMs();
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.FailoverRelayFirstByteTimeoutMs, v => v.txtFailoverRelayFirstByteTimeoutMs.Text).DisposeWith(disposables);
