...
public partial class MsgView : ReactiveUserControl<MsgViewModel>
{
    ...
    public MsgView()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.OneWayBind(ViewModel, vm => vm.ActiveFailoverGroupName, v => v.txtActiveFailoverGroup.Text).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.ActiveFailoverGroupName, v => v.lblActiveFailoverGroup.Content).DisposeWith(disposables);
            this.WhenAnyValue(v => v.ViewModel!.IsFailoverModeFailover)
                .Subscribe(active => SetSegmentActive(btnFailoverModeFailover, active))
                .DisposeWith(disposables);
            this.WhenAnyValue(v => v.ViewModel!.IsFailoverModeOff)
                .Subscribe(active => SetSegmentActive(btnFailoverModeOff, active))
                .DisposeWith(disposables);
        });
