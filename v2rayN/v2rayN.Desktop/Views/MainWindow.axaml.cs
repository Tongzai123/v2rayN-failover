...
public partial class MainWindow : WindowBase<MainWindowViewModel>
{
    ...
    public MainWindow()
    {
        ...
        menuCheckFailoverCore.Click += MenuCheckFailoverCore_Click;
    ...
    private void OnHotkeyHandler(EGlobalHotkey e)
    {
        switch (e)
        {
            ...
            case EGlobalHotkey.EnableTun:
                AppEvents.TunModeChangeRequested.Publish(true);
                break;

            case EGlobalHotkey.DisableTun:
                AppEvents.TunModeChangeRequested.Publish(false);
                break;
        }
    }
    ...
    private void MenuCheckFailoverCore_Click(object? sender, RoutedEventArgs e)
    {
        AppEvents.FailoverCoreCheckRequested.Publish();
    }
