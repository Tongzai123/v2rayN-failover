...
public static class AppEvents
{
    ...
    public static readonly EventChannel<SpeedTestResult> SpeedTestResultRequested = new();
    ...
    public static readonly EventChannel<Unit> FailoverStateChangedRequested = new();
    public static readonly EventChannel<Unit> FailoverHealthChangedRequested = new();
    public static readonly EventChannel<Unit> FailoverCoreCheckRequested = new();
    ...
    public static readonly EventChannel<bool> TunModeChangeRequested = new();
}
