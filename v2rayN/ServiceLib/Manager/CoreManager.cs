...
public class CoreManager
{
    ...
    public async Task LoadCore(CoreConfigContext? mainContext, CoreConfigContext? preContext)
    {
        ...
        if (_processService != null
            && mainContext.FailoverRuntimeTargetProfileId.IsNotEmpty()
            && _config.FailoverStartupProfileId == mainContext.FailoverRuntimeTargetProfileId)
        {
    ...
    public async Task<ProcessService?> LoadCoreConfigSpeedtest(List<ServerTestItem> selecteds, bool suppressFailover = false)
    {
        ...
        var result = await CoreConfigHandler.GenerateClientSpeedtestConfig(_config, configPath, selecteds, coreType, suppressFailover);
    ...
    public async Task<ProcessService?> LoadCoreConfigSpeedtest(ServerTestItem testItem, bool suppressFailover = false)
    {
