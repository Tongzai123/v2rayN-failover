...
public class OptionSettingViewModel : MyReactiveObject
{
    ...
    [Reactive] public string FailoverRelayFirstByteTimeoutMs { get; set; }
    ...
    private async Task Init()
    {
        ...
        FailoverRelayFirstByteTimeoutMs = FailoverRelayOptions.NormalizeFirstByteTimeoutMs(_config.GuiItem.FailoverRelayFirstByteTimeoutMs).ToString();
    ...
    private async Task SaveSettingAsync()
    {
        ...
        var needReboot = EnableStatistics != _config.GuiItem.EnableStatistics
                        ...
                        || CurrentFontFamily != _config.UiItem.CurrentFontFamily
                        || MainGirdOrientation != (int)_config.UiItem.MainGirdOrientation;
        NormalizeFailoverRelayFirstByteTimeoutMs();
        ...
        _config.GuiItem.FailoverRelayFirstByteTimeoutMs = int.Parse(FailoverRelayFirstByteTimeoutMs);
    ...
    public void NormalizeFailoverRelayFirstByteTimeoutMs()
    {
        FailoverRelayFirstByteTimeoutMs = int.TryParse(FailoverRelayFirstByteTimeoutMs, out var timeoutMs)
            ? FailoverRelayOptions.NormalizeFirstByteTimeoutMs(timeoutMs).ToString()
            : FailoverRelayOptions.DefaultFirstByteTimeoutMs.ToString();
    }
}
