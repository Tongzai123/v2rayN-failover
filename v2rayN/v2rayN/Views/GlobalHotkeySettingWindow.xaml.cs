...
public partial class GlobalHotkeySettingWindow
{
    ...
    private void Init()
    {
        ...
        _textBoxKeyEventItem.Add(txtGlobalHotkey5);
        _textBoxKeyEventItem.Add(txtGlobalHotkey6);
        _textBoxKeyEventItem.Add(txtGlobalHotkey3);
        _textBoxKeyEventItem.Add(txtGlobalHotkey4);

        var hotkeyOrder = new[]
        {
            EGlobalHotkey.ShowForm,
            EGlobalHotkey.SystemProxyClear,
            EGlobalHotkey.SystemProxySet,
            EGlobalHotkey.EnableTun,
            EGlobalHotkey.DisableTun,
            EGlobalHotkey.SystemProxyUnchanged,
